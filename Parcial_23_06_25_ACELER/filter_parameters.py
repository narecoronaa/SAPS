...
def filter_parameters(fil):
    ...
    if tipo == 'BP':
        if (fil['creator'][1] == 'pyfda.filter_designs.cheby1' or fil['creator'][1] == 'pyfda.filter_designs.cheby2' or fil['creator'][1] == 'pyfda.filter_designs.butter' or fil['creator'][1] == 'pyfda.filter_designs.bessel' or 'pyfda.filter_widgets.cheby1' or fil['creator'][1] == 'pyfda.filter_widgets.cheby2' or fil['creator'][1] == 'pyfda.filter_widgets.butter' or fil['creator'][1] == 'pyfda.filter_widgets.bessel'):
